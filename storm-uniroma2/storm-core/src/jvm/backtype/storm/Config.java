...
public class Config extends HashMap<String, Object> {
    ...
    public static final String FIRESTORM_ENABLED = "firestorm.enabled";
    public static final Object FIRESTORM_ENABLED_SCHEMA = Boolean.class;
    ...
    */
    ...
    /*
    * Following section contains configuration parameters for 
    * FireStorm developed by the University of Rome "Tor Vergata" 
    * 
    * Author: Dario Luzi
    */
 
    /**
     * Monitor server update frequency of the monitored executors list on the current node. When executor is discovered
     * metrics collection is started
     */
    public static final String TAOS_QUEUE_DIRECTORY_CHECK_PERIOD="taos.queue_directory_check_period";
    public static final Object TAOS_QUEUE_DIRECTORY_CHECK_PERIOD_SCHEMA=Number.class;

    /**
     * Timeout period for receiving a message from an executor on current node.
     * After this time the executor is considered dead. Monitor server
     * stops metric collection for it.
     */
    public static final String TAOS_QUEUE_DELETE_TIMEOUT="taos.queue_delete_timeout";
    public static final Object TAOS_QUEUE_DELETE_TIMEOUT_SCHEMA=Number.class;
    /**
     * Time interval between two CPU advertising message from an executor to the monitor server inside the Supervisor
     */
    public static final String TAOS_CPU_TIME_ADVERTISE_PERIOD="taos.cpu_time_advertise_period";
    public static final Object TAOS_CPU_TIME_ADVERTISE_PERIOD_SCHEMA=Number.class;
    /**
     * Exponential smoothing factor for collected metrics. This configuration regulates sensibility
     * of collected metrics to the variability of the real value.
     */
    public static final String TAOS_METRICS_SMOOTHING="taos.metrics_smoothing";
    public static final Object TAOS_METRICS_SMOOTHING_SCHEMA=Double.class;
    /**
     * Time interval between submissions of metrics updates to the database
     */
    public static final String TAOS_METRICS_UPDATE_PERIOD="taos.metrics_update_period";
    public static final Object TAOS_METRICS_UPDATE_PERIOD_SCHEMA=Number.class;
    /**
     * Time to live of metrics in the database, after this time metrics are deleted
     */
    public static final String TAOS_DB_TTL="taos.db_ttl";
    public static final Object TAOS_DB_TTL_SCHEMA=Number.class;
    /**
     * Ip address of metrics database
     */
    public static final String TAOS_MONGO_DB_IP="taos.mongo_db_ip";
    public static final Object TAOS_MONGO_DB_IP_SCHEMA=String.class;
    /**
     * port of metrics database
     */  
    public static final String TAOS_MONGO_DB_PORT="taos.mongo_db_port";
    public static final Object TAOS_MONGO_DB_PORT_SCHEMA=Number.class;
    /**
     * Ip address of schedule generator web server
     */
    public static final String TAOS_GENERATOR_IP="taos.generator_ip";
    public static final Object TAOS_GENERATOR_IP_SCHEMA=String.class;
    /**
     * port of schedule generator web server
     */
    public static final String TAOS_GENERATOR_PORT="taos.generator_port";
    public static final Object TAOS_GENERATOR_PORT_SCHEMA=Number.class;    
    /**
     * Target utilization for a node in the cluster, this is node specific.
     */
    public static final String TAOS_TARGET_UTILIZATION="taos.target_utilization";
    public static final Object TAOS_TARGET_UTILIZATION_SCHEMA=Double.class;
    
    /**
     * Safe time between two schedule decisions in the Fetcher. New schedules and scaling decisions are ignored during this interval.
     * This time lets topologies execute without perturbation for stabilization and metrics collection.
     */
    public static final String TAOS_SCHEDULE_FETCH_TIME="taos.schedule_fetch_time";
    public static final Object TAOS_SCHEDULE_FETCH_TIME_SCHEMA=Number.class;
    /**
     * Set false if no state management during migration is desired
     */
    public static final String TAOS_SMOOTH_ENABLED="taos.smooth.enabled";
    public static final Object TAOS_SMOOTH_ENABLED_SCHEMA=Boolean.class;
    /**
     * ScheduleFetcher waits at most this time for tasks to complete state management operation, then 
     * the migration is started anyway
     */
    public static final String TAOS_SMOOTH_TIMEOUT="taos.smooth.timeout";
    public static final Object TAOS_SMOOTH_TIMEOUT_SCHEMA=Number.class;
    /**
     * Task waits at most this time for an EOF to arrive, then it continues with the  migration
     * anyway
     */
    public static final String TAOS_SMOOTH_EOF_TIMEOUT="taos.smooth.eof.timeout";
    public static final Object TAOS_SMOOTH_EOF_TIMEOUT_SCHEMA=Number.class;
    /**
     * Upper CPU utilization threshold for operator parallelism up-scale decisions.
     * For stability AUTOSCALING_UPSCALE_THRESHOLD=2*AUTOSCALING_DOWNSCALE_THRESHOLD+ T
     * where T is some tolerance slack.
     */   
    public static final String AUTOSCALING_UPSCALE_THRESHOLD="autoscaling.upscale_threshold";
    public static final Object AUTOSCALING_UPSCALE_THRESHOLD_SCHEMA=Double.class;
    /**
     * Lower CPU utilization threshold for operator parallelism down-scale decisions.
     */ 
    public static final String AUTOSCALING_DOWNSCALE_THRESHOLD="autoscaling.downscale_threshold";
    public static final Object AUTOSCALING_DOWNSCALE_THRESHOLD_SCHEMA=Double.class;
    /**
     * Minimum down-scale factor for an operator. If operator has N tasks, then at least N/(AUTOSCALING_MAX_DOWNSCALE_FACTOR) are used.
     */ 
    public static final String AUTOSCALING_MAX_DOWNSCALE_FACTOR="autoscaling.max_downscale_factor";
    public static final Object AUTOSCALING_MAX_DOWNSCALE_FACTOR_SCHEMA=Integer.class;
    /**
     * Ignores up-scales where added replicas are not at least AUTOSCALING_WEAK_SCALE_THRESHOLD*maxScale, where maxScale
     * is the maximum number of replicas that can be added in the current up-scale decision. This parameter controls 
     * the sensibility for the scaling algorithm.
     */ 
    public static final String AUTOSCALING_WEAK_SCALE_THRESHOLD="autoscaling.weak_scale_threshold";
    public static final Object AUTOSCALING_WEAK_SCALE_THRESHOLD_SCHEMA=Double.class;
    /**
     * After up-scale decision, if for operator O NumberOfTask(O)-NumberOfExecutor(O)<AUTOSCALING_SCALE_TO_MAX_THRESHOLD*NumberOfTask(O), then
     * the maximum parallelism for operator O is chosen instead. This threshold controls the speed with which maximum parallelism is reached.
     * Low values should be used (10%), otherwise algorithm will be unstable.
     */ 
    public static final String AUTOSCALING_SCALE_TO_MAX_THRESHOLD="autoscaling.scale_to_max_threshold";
    public static final Object AUTOSCALING_SCALE_TO_MAX_THRESHOLD_SCHEMA=Double.class;
    
    public static final String METRICS_SPOUT_NAME="metrics.spout.name";
    public static final Object METRICS_SPOUT_NAME_SCHEMA=String.class;

    public static final String METRICS_UTIL_NORM="metrics.util.norm";
    public static final Object METRICS_UTIL_NORM_SCHEMA=Double.class;
